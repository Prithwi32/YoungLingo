      ...
      <main className="flex-grow container mx-auto px-4 py-12 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center mb-16 gap-32">
            <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="text-xl mb-8 text-gray-500 animate-fade-in-up">
                Enhance your language skills with our cutting-edge AI-powered
                learning platform. We offer personalized lessons to improve your
                pronunciation and focus your learning efforts.
              </p>
              <div className="flex items-center justify-center ">
                <Button href="/get-started" className="animate-pulse w-40 ">
                  Get Started
                </Button>
              </div>
            </div>
          ...
          <div className="space-y-12 mb-16">
            <h2 className="text-3xl font-semibold text-purple-800 text-center animate-fade-in">
              Key Features:
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center bg-white bg-opacity-50 rounded-lg p-6 shadow-lg transition-transform duration-300 hover:scale-105 animate-fade-in-up"
          ...
          <div className="text-center">
            <h2 className="text-3xl font-semibold text-purple-800 mb-8 animate-fade-in">
              Start Your Language Journey Today
            </h2>
            <div className="flex items-center justify-center ">
              <Button
                href="/get-started"
                className="animate-bounce bg-purple-800 rounded-full"
              >
                Begin Learning
              </Button>
            </div>
