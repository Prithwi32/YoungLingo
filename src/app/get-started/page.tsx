...
//         <h1 className="text-3xl font-bold mb-6 text-center text-purple-600">Get Started with LinguaLearn AI</h1>
...
//             <h2 className="text-2xl font-semibold mb-4 text-purple-700">Improve Pronunciation</h2>
...
//           </div>
//           <div className="bg-indigo-100 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
//             <h2 className="text-2xl font-semibold mb-4 text-purple-700">Improve Focus</h2>
        ...
        <div className="max-w-6xl w-full">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
              <h2 className="text-2xl font-semibold mb-4 text-purple-700">Improve Pronunciation</h2>
              <p className="text-gray-700 mb-6">Perfect your accent and speech clarity with our AI-powered pronunciation trainer.</p>
             <Button onClick={() => handleOptionSelect('pronunciation')} href="/pronunciation"
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
              <h2 className="text-2xl font-semibold mb-4 text-purple-700">Improve Focus</h2>
              <p className="text-gray-700 mb-6">Enhance your language learning efficiency with our focused listening exercises.</p>
              <Button 
                onClick={() => handleOptionSelect('focus')} href="/focus"
                className="w-full bg-orange-600 hover:bg-orange-500 text-white font-semibold py-3 rounded-lg transition-colors duration-300"
